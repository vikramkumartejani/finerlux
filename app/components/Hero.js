     ...
     return (
          <div className="px-5 mt-[35px]">
               <div className="max-w-[1360px] w-full mx-auto bg-white hidden md:flex items-center justify-between rounded-[45px] h-[622px] relative overflow-hidden">
                    ...
                    <div className='w-full pl-8 pt-[135px]'>
                         <h1 className='max-w-[500px] text-[40px] !leading-[95%] font-semibold'>We help watch collectors do more of what they love.</h1>
                    </div>
               ...
               <div className='md:hidden block'>
                    <div className='h-[265px] w-full bg-white rounded-[30px] relative flex items-end justify-end'>
                         ...
                         <div className=' absolute z-40 flex items-end justify-end right-2 top-0 h-full'>
                              <img src="/assets/hero-watch.png" alt='kmg' className='w-full h-full bg-contain' />
                         </div>
                         <LiveChatButton />
                    </div>
                    <h2 className='mt-6 text-center text-[22px] leading-[95%] font-semibold'>We help watch collectors do more of what they love.</h2>
                    <Content/>
               </div>
          </div>
     );
