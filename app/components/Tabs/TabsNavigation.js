               ...
               <div className="w-full flex flex-wrap sm:flex-nowrap justify-center sm:justify-between lg:justify-evenly items-center gap-2">
                    {tabs.map((tab) => (
                         <button
                              ...
                              className={`px-3.5 md:px-5 lg:px-8 py-[5px] md:py-2 text-nowrap rounded-[30px] text-sm md:text-lg font-normal transition-colors ${activeTab === tab.id ? "bg-[#017EFE] text-white" : "text-black hover:bg-white"
                                   }`}
                         >
                              {tab.label}
                         </button>
